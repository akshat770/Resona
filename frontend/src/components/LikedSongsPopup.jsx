...
export default function LikedSongsPopup({ isOpen, onClose, playerReady, isPremium, playlists = [] }) {
  ...
  // Play individual track with queue context
  ...
  // Play all liked songs with queue
  ...
  return (
    <>
      ...
      <div className="fixed inset-2 lg:inset-4 bg-gray-900 rounded-xl lg:rounded-2xl z-50 flex flex-col overflow-hidden shadow-2xl border border-gray-700">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-green-600 p-4 lg:p-6 flex items-center justify-between">
          <div className="flex items-center gap-3 lg:gap-4">
            <div className="w-12 h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-purple-500 to-green-500 rounded-xl flex items-center justify-center">
              <svg className="w-6 h-6 lg:w-8 lg:h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                <path d="m12 21.35-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
              </svg>
            </div>
            <div>
              <h1 className="text-xl lg:text-3xl font-bold text-white">Liked Songs</h1>
        ...
        <div className="bg-gray-800 px-4 lg:px-6 py-3 lg:py-4 flex items-center gap-3 lg:gap-4 border-b border-gray-700">
          ...
          <button
            ...
            className="bg-gray-700 hover:bg-gray-600 text-white px-3 lg:px-4 py-2 rounded-lg font-medium transition-colors text-sm lg:text-base"
          >
