          ...
          <div className="bg-gray-800 px-4 py-3 flex items-center gap-3 border-b border-gray-700 flex-shrink-0">
            ...
            >
              <span className="relative w-4 h-4 flex items-center justify-center">
                <svg
                  className={`absolute w-4 h-4 transition-all duration-200 ${isPlayAllActive ? "opacity-0 scale-75" : "opacity-100 scale-100 ml-0.5"}`}
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <svg
                  className={`absolute w-4 h-4 transition-all duration-200 ${isPlayAllActive ? "opacity-100 scale-100" : "opacity-0 scale-75"}`}
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
