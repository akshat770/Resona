...
export default function SpotifyPlayer({ accessToken, onPlayerReady }) {
  ...
  // UPDATED: Use AddToPlaylistPopup instead of custom dropdown
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 border-t border-gray-700 backdrop-blur-sm z-50">
        ...
        <div className="lg:hidden p-3">
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            {/* UPDATED: Mobile Action buttons with Volume */}
            <div className="flex items-center gap-1">
              {/* Mobile Volume Control */}
              <div className="relative" ref={volumeContainerRef}>
                <button
                  onClick={() => setShowVolumeSlider(!showVolumeSlider)}
                  className="text-gray-300 hover:text-white p-2 rounded-full relative border border-gray-600/30 bg-gray-700/40 hover:bg-green-700/50 transition-all duration-200"
                >
                ...
                {showVolumeSlider && (
                  <div className="absolute bottom-full right-0 mb-2 bg-[#282828]/95 backdrop-blur-sm rounded-xl p-4 shadow-2xl border border-gray-600/40 z-20">
                    <div className="flex flex-col items-center gap-3">
                      {/* Volume Percentage */}
                      <div className="text-xs text-green-500 font-mono font-semibold">
                      ...
                      <div className="relative w-24 h-2 bg-gray-700 rounded-full">
                        <div 
                          className="absolute left-0 h-2 bg-gradient-to-r from-green-600 via-green-400 to-green-300 rounded-full transition-all duration-200"
              ...
              {/* UPDATED: Use popup instead of dropdown */}
              <button
                onClick={() => setShowAddToPlaylistPopup(true)}
        ...
        <div className="hidden lg:block p-4">
          <div className="max-w-screen-xl mx-auto flex items-center justify-between">
            ...
            <div className="flex items-center gap-4 flex-1 min-w-0">
              ...
              {/* UPDATED: Desktop Like/Add buttons */}
              <div className="flex items-center gap-2">
                <button
                  onClick={toggleLiked}
            ...
            <div className="flex items-center gap-3 flex-1 justify-end relative">
              ...
              >
                <button
                  onClick={toggleMute}
                  className="text-gray-300 hover:text-white transition-all duration-200 p-2 rounded-full hover:bg-gray-700/70 hover:shadow-lg group relative border border-gray-600/30 bg-gray-700/30"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    {getVolumeIcon()}
                  </svg>
                ...
                {showVolumeSlider && (
                  <div className={`absolute bottom-full right-0 mb-2 transition-all duration-300 ${
                    ...
                    <div 
                      className="bg-[#282828]/95 backdrop-blur-sm rounded-xl p-4 shadow-2xl border border-gray-600/40"
                    ...
                    >
                      <div className="flex flex-col items-center gap-3">
                        ...
                        <div className="relative h-24 w-2 bg-gray-700 rounded-full">
                          <div 
                            className="absolute bottom-0 w-2 bg-gradient-to-t from-green-600 via-green-400 to-green-300 rounded-full transition-all duration-200"
                          ...
                          {[0.8, 0.6, 0.4, 0.2].map((level) => (
                            <div
                              ...
                              className={`w-1 h-1 rounded-full transition-all duration-200 ${
                                volume >= level ? 'bg-green-500 shadow-green-500/50' : 'bg-gray-600'
                              }`}
                              style={{ 
