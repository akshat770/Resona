...
import { MADE_FOR_YOU_ITEMS, QUICK_ACTIONS } from "../components/dashboard/dashboardData";
...
export default function Dashboard({ playerReady, isPremium, setAccessToken, setIsPremium, setIsAuthenticated }) {
  ...
  const quickActions = QUICK_ACTIONS(isPremium, setShowLikedSongsPopup, setShowAIPlaylistGenerator);
    ...
    <div className="flex min-h-screen bg-gray-900 text-white pb-24 relative">
        ...
        <div className="p-6 lg:p-8 max-w-7xl mx-auto">
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
              {MADE_FOR_YOU_ITEMS.map((item, index) => (
      ...
      {showSearchUI && (
        <SearchOverlay
          ...
          setSearchLikedSongs={setSearchLikedSongs}
          searchResults={searchResults}
          searchLikedSongs={searchLikedSongs}
