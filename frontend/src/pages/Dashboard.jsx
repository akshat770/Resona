...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-8">
      ...
      <button onClick={connectSpotify} className="bg-green-500 hover:bg-green-600 px-4 py-2 rounded-lg mb-4">
        Connect Spotify
      </button>
      <button onClick={loadData} className="bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded-lg mb-4 ml-2">
        Refresh
      </button>
      <button onClick={logout} className="bg-red-500 hover:bg-red-600 px-4 py-2 rounded-lg mb-4 ml-2">
        Logout
      </button>
